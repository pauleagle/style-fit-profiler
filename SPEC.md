...
| `CR-001` Appeal Point and Art Style Extraction | Active post-P0 implementation; next cursor `CR-001-07B` | [`specs/backlog/CR-001-appeal-point-and-art-style-extraction.md`](specs/backlog/CR-001-appeal-point-and-art-style-extraction.md) |
