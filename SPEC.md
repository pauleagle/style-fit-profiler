...
| `CR-001-FU-01` Deprecate Legacy Phase 0 Default Paths | Implemented; docs cleanup, regression verification, and import smoke complete | [`specs/backlog/CR-001-FU-01-deprecate-legacy-phase0-default-paths.md`](specs/backlog/CR-001-FU-01-deprecate-legacy-phase0-default-paths.md) |
