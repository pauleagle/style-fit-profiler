...
| `CR-001` Appeal Point and Art Style Extraction | Backlog / post-P0 change request; Devil's Advocate gate currently `blocked` | [`specs/backlog/CR-001-appeal-point-and-art-style-extraction.md`](specs/backlog/CR-001-appeal-point-and-art-style-extraction.md) |
